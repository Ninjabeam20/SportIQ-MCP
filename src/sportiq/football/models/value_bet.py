...
excess is the bookmaker's margin ("vig" / "overround"). De-vigging normalises the
implied probabilities back to sum 1 so they're comparable to a true probability.
