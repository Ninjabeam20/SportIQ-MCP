---
name: test-runner
description: Runs the pytest suite in isolation and returns only failures. Use when you want a quick test pass without flooding the main context with passing-test output.
tools: Bash, Read
---
